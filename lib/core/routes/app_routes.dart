class AppRoutes {
  ...
  static const customerSearchFilter =
      '/customer/search-filter';

  static const customerProductDetail =
      '/customer/product-detail';

  static const customerCart =
      '/customer/cart';

  static const customerCheckout =
      '/customer/checkout';

  static const customerPayment =
      '/customer/payment';

  static const customerOrderSuccess =
      '/customer/order-success';

  static const customerOrderTracking =
      '/customer/order-tracking';

  static const customerFarmDetail =
      '/customer/farm-detail';

  static const customerFarmMap =
      '/customer/farm-map';

  static const customerFarmProducts =
